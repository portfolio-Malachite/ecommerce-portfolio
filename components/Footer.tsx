...
const columns = [
  ...
  {
    title: "Hot Items",
    links: ["Streetwear", "Hoodies", "Sneakers", "Jackets", "Bags", "Caps"]
  },
  {
    title: "Company",
...
function hrefFor(label: string) {
  const map: Record<string, string> = {
    ...
    Men: "/hot-items",
    Women: "/hot-items",
    Accessories: "/hot-items",
    Sale: "/deals",
    Streetwear: "/hot-items",
    Hoodies: "/hot-items",
    Sneakers: "/hot-items",
    Jackets: "/hot-items",
    Bags: "/hot-items",
    ...
    <footer className="relative overflow-hidden border-t border-black/5 bg-gradient-to-br from-white via-slate-50 to-violet-50 text-ink">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid gap-8 border-b border-black/10 py-14 lg:grid-cols-[1fr_0.9fr] lg:items-center">
          <div>
            ...
            <p className="mt-4 max-w-xl text-sm leading-7 text-neutral-500">
              Join the private Velora list for first looks, limited releases, and members-only street luxury edits.
            </p>
          </div>
        ...
        <div className="grid gap-9 py-12 sm:grid-cols-2 lg:grid-cols-6">
          <div>
            <h3 className="text-3xl font-black tracking-tight">Velora</h3>
            <p className="mt-4 text-sm leading-7 text-neutral-500">
              Luxury fashion and streetwear essentials shaped for the next drop culture.
            </p>
