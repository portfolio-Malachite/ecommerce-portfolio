  ...
  return (
    <article className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="mt-10 grid gap-6 text-lg leading-8 text-neutral-700 dark:text-neutral-300">
        ...
        <p>Velora uses editorial product pages, refined filters, persistent cart state, and a warmer recommendation layer to help shoppers make decisions without friction.</p>
      </div>
