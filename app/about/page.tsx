      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-12 sm:px-6 lg:grid-cols-2 lg:px-8">
        <div>
          ...
          <p className="mt-6 text-lg leading-8 text-neutral-600 dark:text-neutral-300">
            Velora was built around a simple belief: ecommerce should feel intelligent, elegant, and deeply usable. We curate premium essentials across style, tech, travel, and daily rituals.
          </p>
        </div>
        <div className="relative aspect-[4/5] overflow-hidden rounded-[2rem] shadow-luxury">
          <Image src="https://images.unsplash.com/photo-1441986300917-64674bd600d8?q=80&w=1200&auto=format&fit=crop" alt="Velora retail studio" fill className="object-cover" />
        </div>
      </div>
