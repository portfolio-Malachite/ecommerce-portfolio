...
export default function OrderSuccessPage() {
  return (
    <section className="mx-auto flex min-h-[70vh] max-w-4xl flex-col items-center justify-center px-4 text-center">
      ...
      <p className="mt-4 max-w-xl text-neutral-500 dark:text-neutral-400">Your Velora order is being prepared. Tracking updates will appear as each delivery stage completes.</p>
